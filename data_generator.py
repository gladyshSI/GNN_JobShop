...
if __name__ == '__main__':
    ...
    for distribution_type in distribution_types:
        ...
        # generate_random_tasks(butch_size=100, num_tasks=122, distribution_type=distribution_type, folder=folder)
        generate_random_tasks(butch_size=1, num_tasks=194, distribution_type=distribution_type, folder=folder)
